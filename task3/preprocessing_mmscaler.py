...
if __name__ == '__main__':
	...
	with open('features_all_train_mmscaler.txt','w') as f:
	...
	df_train.to_csv('X_train_features_mmscaler.csv',index=True)
	df_test.to_csv('X_test_features_mmscaler.csv',index=True)
