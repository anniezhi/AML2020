...
if __name__ == '__main__':
	...
	with open('features_all_train_stdscaler.txt','w') as f:
	...
	df_train.to_csv('X_train_features_stdscaler.csv',index=True)
	df_test.to_csv('X_test_features_stdscaler.csv',index=True)
