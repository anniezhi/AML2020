...
if __name__ == '__main__':
	# import data - train sub2 & sub3 (train)
	...
	# combine train data
	input_train = np.concatenate((input_train_sub1, input_train_sub3),axis=0)
	#label_train = np.concatenate((label_train_sub1_onehot, label_train_sub2_onehot),axis=0)
	label_train = np.concatenate((label_train_sub1, label_train_sub3),axis=0)
	...
	input_val, label_val = unison_shuffle(input_train_sub2, label_train_sub2)
	...
	np.save('label_pred_2.npy',label_val_pred)
